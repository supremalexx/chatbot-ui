...
AS $$
DECLARE
  project_url TEXT := 'https://nsfgkauhhtogxbuqqbhk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5zZmdrYXVoaHRvZ3hidXFxYmhrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0OTY4NDEwNCwiZXhwIjoyMDY1MjYwMTA0fQ.i32X8NGU77K16b-IpRT7ziwLnnRwDhpq0aAnGeQ0BD0'; -- full access needed for http request to storage
